...
const   struct  cmd_type        cmd_table       [] =
{
	...
	/* IMC Mortal commands */
    { "]",              do_rchat,       POS_SLEEPING,   20,   LOG_NORMAL},
    { "rchat",          do_rchat,       POS_SLEEPING,   20,   LOG_NORMAL},
    { "rtell",          do_rtell,       POS_SLEEPING,   30,   LOG_NORMAL},
    ...
    { "rimclist",       do_imclist,       POS_DEAD,       5,   LOG_NORMAL},
    { "rcode",          do_rcode,       POS_SLEEPING,   L_DEI,   LOG_NORMAL},
    { "rbeep",          do_rbeep,       POS_SLEEPING,  80,   LOG_NORMAL},
    { "istats",         do_istats,      POS_SLEEPING,   L_DEI,   LOG_NORMAL},
...
/* one or more of the poses crash us  */
    ...
    { "disguise",       do_disguise,	POS_STANDING,     0,  LOG_NORMAL },
    ...
    { "areasave",	do_areasave,	POS_DEAD,	L_SUP,  LOG_NORMAL },  
    ...
    { "setclass",       do_setclass,    POS_DEAD,    L_ANG,		LOG_ALWAYS },
    ...
    { "rimm",           do_rimm,        POS_DEAD,      L_SUP,   LOG_NORMAL},
    { "rinfo",          do_rinfo,       POS_DEAD,      L_SUP,   LOG_NORMAL},
    { "rsockets",       do_rsockets,    POS_DEAD,      L_SUP,   LOG_NORMAL},
    { "rconnect",       do_rconnect,    POS_DEAD,      L_SUP,   LOG_ALWAYS},
    { "rdisconnect",    do_rdisconnect, POS_DEAD,      L_SUP,   LOG_ALWAYS},
    { "rignore",        do_rignore,     POS_DEAD,      L_SUP,   LOG_ALWAYS},
    { "imc",            do_imc,         POS_DEAD,      L_GOD,   LOG_ALWAYS},
    { "mailq",          do_mailqueue,   POS_DEAD,      86,   LOG_NORMAL},
