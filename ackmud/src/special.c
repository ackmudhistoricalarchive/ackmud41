...
/*       break;
    ...
    act( "$n says 'Hello $N, you little love!", ch, NULL, victim, TO_ROOM );

    act( "$n hugs $N, and pecks $M on the cheek!", ch, NULL, victim, TO_NOTVICT );
    act( "$N hugs you, and pecks you on the cheek!", victim, NULL, ch, TO_CHAR );
    
    act( "$n waves her magic wand towards $N.", ch, NULL, victim, TO_NOTVICT );
    act( "$N waves her magic wand towards you.", victim, NULL, ch, TO_CHAR );
    sn = skill_lookup( "cure light" );
    spell_cure_light( sn, ch->level, ch, victim, NULL );
    return TRUE;
}
