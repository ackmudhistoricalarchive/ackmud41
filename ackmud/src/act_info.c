...
char *  get_family_name     ( CHAR_DATA *ch ) 
{
	...
	case 1  : return "@@mCHANGE ME@@N" ;
	case 2  : return "@@eCHANGE ME@@N" ;
	case 3  : return "@@lCHANGE ME@@N" ;
	case 4  : return  "@@dCHANGE ME@@N" ;
      }
...
char *  get_tribe_name     ( CHAR_DATA *ch ) 
{
    ...
    switch ( ch->pcdata->vamp_bloodline )
      {
	default : return "Renegade!";
	case 1  : return "@@yCHANGE ME@@N" ;
	case 2  : return "@@rCHANGE ME@@N" ;
	case 3  : return "@@eCHANGE ME@@N" ;
	case 4  : return "@@bCHANGE ME@@N" ;
      }
